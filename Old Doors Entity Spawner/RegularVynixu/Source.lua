...
local SelfModules = {
    DefaultConfig = loadstring(game:HttpGet("https://raw.githubusercontent.com/Tricot676/Doors-Modes/refs/heads/main/Old%20Doors%20Entity%20Spawner/RegularVynixu/DefaultConfig.lua"))(),
